...
// This is a callback function for when the client requests /device/perintah:
function getSensorReading(request, response) {
	// the parameter after /device/ is the perintah number:
	var perintah = request.params.perintah;
	console.log("Ambil Perintah: "+ perintah + "...");

	// send the perintah number out the serial port
	//and wait for a response:
	myPort.write(perintah, function(){
...
app.get('/device/:perintah', getSensorReading);	// GET handler for /device
